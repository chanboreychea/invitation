                ...
                <div class="content-left">
                    <div class="content-top">
                        <div class="content-topleft">
                            <div class="content-topleft-menutitle">
                                <div class="menutitle-line">

                                    <div class="menutitle">
                                        @foreach ($indextitle as $item)
                                            {{ $item->categorieName }}
                                        @endforeach
                            ...
                            <div class="content-topleft-boxwapper">

                                @foreach ($contenttopleftbox as $item)
                                    <div class="content-topleft-box">
                                        <div class="content-topleft-boximage">
                                            <a href="{{ url('categorie/' . $item->id) }}">
                                                <img src="{{ asset('upload/nationalFootball/' . $item->image) }}"
                                                    width="100%">
                                            </a>
                                        </div>
                                        <div class="content-topleft-boxtitle">
                                            <p>{{ $item->title }}</p>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="content-topright">
                            ...
                            @foreach ($contenttopright as $item)
                                <div class="content-topright-img">
                                    <a href="{{ url('categorie/' . $item->id) }}">
                                        <img src="{{ asset('upload/nationalFootball/' . $item->image) }}"
                                            width="100%">
                                    </a>
                                </div>
                                <div class="content-topright-title">
                                    <p>{{ $item->title }}</p>
                                </div>
                            @endforeach
                        </div>
